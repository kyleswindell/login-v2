...
- does NOT update active workflow state
...
- If the information is actually canonical truth, STOP and route it to the correct canonical owner
- If the information is really a durable repo rule, workflow behavior, or reusable starter-pack improvement, STOP and route it to the target repo's `AGENTS.md`, relevant skill file, or baseline package instead of memory
- If the information is active workflow state, STOP and route it to the active workflow owner path
