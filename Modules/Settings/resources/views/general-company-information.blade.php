<x-layouts.app
    ...
    page-subtitle="Core organization details used across platform communication and branding surfaces."
>
    <x-slot:pageTabs>
        @include('settings::_general-tabs', ['generalTab' => 'company-information'])
    </x-slot:pageTabs>
        ...
        <form method="POST" action="{{ route('platform.settings.general.company-information.update') }}" class="rounded-lg border border-slate-800 bg-slate-900/70 p-8 shadow-2xl shadow-black/30">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <label class="block">
                    ...
                    <input type="text" name="company_phone" value="{{ old('company_phone', $companyPhone) }}" class="mt-2 w-full rounded-md border border-slate-700 bg-slate-950 px-4 py-3 text-slate-100" data-ui-phone-input inputmode="tel" autocomplete="tel" placeholder="(555) 555-5555">
                </label>
