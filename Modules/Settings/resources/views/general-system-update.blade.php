<x-layouts.app
    ...
    page-title="System Update"
    page-subtitle="Choose update channel policy and operational maintenance defaults."
>
    <x-slot:pageTabs>
        @include('settings::_general-tabs', ['generalTab' => 'system-update'])
    </x-slot:pageTabs>
