    ...
    public function families(): array
    {
        return [
            [
                ...
                'rows' => [
                    $this->row('Background', 'Page background', '--ui-background', 'rgb(248 250 252)', 'rgb(9 9 11)', 'Implemented', 'Carbon $background role, app-owned value.'),
                    $this->row('Background', 'Background hover', '--ui-background-hover', 'rgb(241 245 249)', 'rgb(39 39 42)', 'Implemented', 'Carbon background-hover behavior, app ramp.'),
                    ...
                    $this->row('Background', 'Inverse background', '--ui-background-inverse', 'rgb(15 23 42)', 'rgb(244 244 245)', 'Implemented', 'High-contrast moments mirror Carbon inverse reasoning.'),
