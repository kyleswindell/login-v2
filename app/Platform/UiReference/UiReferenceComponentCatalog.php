...
class UiReferenceComponentCatalog
{
    ...
    private function components(): array
    {
        return [
            ...
            $this->component('date-picker', 'Date picker', 'Inputs', 'Implemented Pending Review', 'Native date and date-time field for simple date capture; custom calendar and range behavior remain gated.', ['date', 'date-time', 'small', 'medium', 'large', 'fluid', 'error', 'warning', 'disabled', 'read-only', 'loading', 'range gated'], ['Use native controls for simple date entry. Use Forms or filtering Patterns for start/end relationships.']),
