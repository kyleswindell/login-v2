...
class UiReferenceComponentCatalog
{
    ...
    private function components(): array
    {
        return [
            ...
            $this->component('tag', 'Tag', 'Feedback and loading', 'Implemented Pending Review', 'Compact metadata and semantic state labels that do not become actions.', ['neutral', 'info', 'success', 'warning', 'error', 'small', 'medium', 'icon-supported', 'removable gated'], ['Use x-ui.tag for static tags. Use Notification for explanatory feedback and leave removable/filter tags to the owning Pattern.']),
