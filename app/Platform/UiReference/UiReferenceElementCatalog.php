        ...
        return [
            ...
            $this->element(
                ...
                related: [
                    ...
                    ['label' => 'Canonical grid doc', 'href' => '/platform/docs?path=02-standards%2Fui%2Felements%2Fgrid.md'],
            ...
            $this->element(
                ...
                related: [
                    ['label' => '2x Grid element', 'href' => '/platform/ui-reference/elements/grid'],
            ...
            $this->element(
                ...
                tokens: [
                    ...
                    ['name' => 'Code/mono', 'variable' => 'font-mono with text tokens', 'api' => 'code block utilities', 'example' => '<code>--ui-text-strong</code>'],
                ],
                usage: [
                    ...
                    'Common app examples: admin page titles, settings forms, data tables, empty states, notifications, and inline validation.',
                ],
                accessibility: [
                ...
                developerNotes: [
                    ...
                    'Productive type is the default for app UI.',
                ...
                carbonComparison: 'Carbon typography informs role-based type tokens. Login App does not adopt IBM Plex-specific type sets by default.',
            ),
            $this->element(
                slug: 'icons',
                label: 'Icons',
