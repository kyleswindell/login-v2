...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Keep the package's default table names in Phase 1 so the auth layer stays
        // conventional and we avoid inventing platform-specific prefixes too early.
    ...
    public function down(): void
    {
        ...
        throw_if(empty($tableNames), 'Error: config/permission.php not found and defaults could not be merged. Drop the tables manually if needed.');
