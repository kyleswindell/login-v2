# App 2.0 Docs Start Here

Use this as the root entry point for App 2.0 docs.
...
- Canonical flow execution paths live in [05-flows/index.md](05-flows/index.md).
- Canonical database contracts live in [06-database/index.md](06-database/index.md).
