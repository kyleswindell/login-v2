...
| Content switcher   | Deferred API           | No public API approved                                        | use tabs until switcher-specific need exists                                  | `/platform/ui-reference/components/content-switcher`   |
| Data table         | Approved API           | table component surface plus table Pattern handoff            | sortable, filterable, row actions, loading, empty, responsive overflow        | `/platform/ui-reference/components/data-table`         |
| Date picker        | Approved API           | `x-ui.date-picker`                                            | native date, date-time, validation, disabled/readonly; range deferred         | `/platform/ui-reference/components/date-picker`        |
...
| Loading            | Approved API           | spinner/skeleton family                                       | spinner, skeleton text/card/table, reduced motion                             | `/platform/ui-reference/components/loading`            |
...
| Pagination         | Approved API           | `x-ui.pagination`                                             | full, compact, page size, disabled prev/next, overflow                        | `/platform/ui-reference/components/pagination`         |
