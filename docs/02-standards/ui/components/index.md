...
| Combo box          | Queued gap             | No public API approved                                        | typed filtering, clear control, custom-value gate, keyboard contract         | `/platform/ui-reference/components/combo-box`          |
...
| Date picker        | Approved API           | `x-ui.date-picker`, `x-ui.date-picker-input`, `x-ui.date-picker-skeleton`, `initDatePickers` | simple input, single calendar, range calendar, skeleton, validation, disabled/readonly | `/platform/ui-reference/components/date-picker`        |
...
| Tag                | Approved API           | `x-ui.tag`, `x-ui.tag-group`                                  | metadata, dismissible filters, selectable choices, operational disclosure      | `/platform/ui-reference/components/tag`                |
