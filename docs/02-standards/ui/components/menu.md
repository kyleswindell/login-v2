...
| Source files                 | `resources/views/components/ui/menu.blade.php`; `resources/views/components/ui/menu-item.blade.php`; `resources/js/ui-controls/menus.js`; `resources/css/app.css` |
...
| Form submission menu items with non-GET methods | Gated       | Requires CSRF/method spoofing contract, confirmation rules, and tests. Prefer explicit forms or confirmation flows.                           |
