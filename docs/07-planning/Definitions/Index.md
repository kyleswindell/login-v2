...
summary: Routes canonical reusable architecture, organization, extension, technical-role, and delivery-adapter definitions for Login 2.0.
-->
...
### 3.2. Organization And Extension Concepts
