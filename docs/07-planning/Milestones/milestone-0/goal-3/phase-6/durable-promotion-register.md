...
- Promotion state: destinations identified; repository synchronization not claimed
...
Paths listed as destinations are promotion targets. Their appearance here does not claim repository application or validation.
