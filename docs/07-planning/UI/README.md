...
2. `Definition.md` for the authoritative UI boundary.
...
Additional documents may be added when they own a distinct UI subject that does not belong in `Definition.md`.

## 5. Content Rules

* Keep `Definition.md` authoritative for the UI boundary.
