...
3. Phase 2 finalizes stack, shell/UI ownership, and migration gates before outward-facing expansion.
4. Phase 3 depends on Phase 2 contracts for customer/public access, OAuth, and publishing.
5. Phase 4 depends on Phases 2-3 foundations for remaining module rollout.

## Batch Dependencies

1. Phase 2 Batch 8 must close before Phase 2 Batch 9 starts.
2. Phase 2 Batch 9 messaging rollout depends on account ownership and visibility closure from Batch 8.
3. Contract maintenance and QA close-out batches run only after implementation batches reach exit criteria.
