...
This document defines the canonical scope and intent for Logging Notifications And Options Foundation.
...
* [Phase 1 - Implementation Batch 3](Phase%201%20-%20Implementation%20Batch%203.md)
* [Phase 1 - Implementation Batch 4](Phase%201%20-%20Implementation%20Batch%204.md)
...
* [Logging Data Model Notes](../../../09-reference/architecture/app-2-0-logging-db-columns-research.md)
* [Event And Error Logging](../../../04-features/logging/event-and-error-logging.md)
* [Platform Notifications And Settings](../../../04-features/notifications/platform-notifications-and-settings.md)
* [Logging Standards](../../../02-standards/logging/Logging%20Standards.md)
* [Release Notes Standards](../../../02-standards/documentation/Release%20Notes%20Standards.md)
