...
This document defines the canonical scope and intent for Phase 2 - UI Surface Disposition Audit.
...
| Dashboard | `/dashboard`, `app/Livewire/Platform/Dashboard/DashboardPage.php`, `resources/views/livewire/platform/dashboard.blade.php` | app-owned Livewire dashboard page with persisted widget layout and shell links | Keep custom | Phase 2 closes with the dashboard as an app-owned surface inside the custom shell; broader Filament ownership is deferred behind explicit parity scope. |
