...
- P2-F-CQ-153 is Implemented Pending Review after worklogs 2-F-0053 and 2-F-0055. Checkbox now uses a dedicated proof matrix for independent choice, multi-select group, states, group states, nesting, overflow, and alignment, with `initCheckboxes` owning parent/child mixed-state synchronization, persistent clicked focus, and stable no-hover checkbox geometry.
- P2-F-CQ-078 passed manual review on 2026-06-12 after worklog 2-F-0054. Code snippet now uses a dedicated proof matrix for inline/single/multi variants, copy tooltip/status behavior, show-more expansion, horizontal overflow, light modifier, and syntax token proof, with `initCodeSnippets` owning copy and expansion behavior. Background-layering follow-up is separated to Color/Foundation proof.
- Starter items P2-F-CQ-002 through P2-F-CQ-006 remain blocked behind manual review of the remaining component recovery queue: P2-F-CQ-075, P2-F-CQ-076, P2-F-CQ-080, P2-F-CQ-136 through P2-F-CQ-150, and P2-F-CQ-152 through P2-F-CQ-163.
...
- P2-F-CQ-075 and P2-F-CQ-076 are Implemented Pending Review. P2-F-CQ-078 passed review after the Code snippet correction; Worklog 2-F-0025 started component-by-component recovery with Tabs, Code snippet, and a generic fallback ban.
