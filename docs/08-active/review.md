...
Visual: `P2-B-CQ-003`, `P2-B-CQ-004`, `P2-B-CQ-005`, `P2-B-CQ-006`, `P2-B-CQ-007`, `P2-B-CQ-008`, `P2-B-CQ-010`, and `P2-B-CQ-011` PASS on staging; `P2-B-CQ-013` FAILS because the temporary review layer still shows stale queue IDs and misses current pending-review coverage on the live proof surfaces; `P2-B-CQ-001` is republished for targeted re-review after `2-B-0019`; `P2-B-CQ-014` is republished for targeted re-review after `2-B-0020`; `P2-B-CQ-017` is republished for targeted re-review after `2-B-0021`
Functional: `P2-B-CQ-003`, `P2-B-CQ-004`, `P2-B-CQ-005`, `P2-B-CQ-006`, `P2-B-CQ-007`, `P2-B-CQ-008`, `P2-B-CQ-010`, and `P2-B-CQ-011` PASS on staging; `P2-B-CQ-013` FAILS because the temporary review layer no longer stays synchronized with the current `Implemented Pending Review` queue across the live proof pages; `P2-B-CQ-001` is republished for targeted re-review after `2-B-0019`; `P2-B-CQ-014` is republished for targeted re-review after `2-B-0020`; `P2-B-CQ-017` is republished for targeted re-review after `2-B-0021`
