...
* [x] Header baseline
  Status: passed review
  Note: manual review approved the worklog `2-A-0010` light-mode notification pill contrast, the worklog `2-A-0011` unread-row treatment, the worklog `2-A-0012` realtime dropdown/toast parity fix, and the worklog `2-A-0013` unread trigger glow retune plus in-place `Mark all as read` interaction.
