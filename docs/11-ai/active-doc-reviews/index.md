...
| doc-review-0021  | 2026-05-30 | `AGENTS.md`, `docs/10-runbooks/batch-workflow.md`, and the active change-queue workflow skills | Docs Review | IMPLEMENTED_PENDING_REVIEW  | implemented                    | Added explicit queue-transition classification, shared-surface parity rules, chat-to-queue normalization, a lightweight queue-item format, and stable queue IDs |
