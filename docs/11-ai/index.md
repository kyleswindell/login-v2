...
Use this branch for AI workflow governance and execution policy.
...
- [Agent Governance Correction Roadmap](workflows/agent-governance-correction-roadmap.md) - historical sequencing reference for the 2026-05 governance correction wave

## Archive

- [Batch archive root](_archive/batches/)
