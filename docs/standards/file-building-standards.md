...
Use Laravel defaults unless the project has a reason to create a clearer platform boundary.

Current custom app namespace direction:
...
Use Blade views for basic platform foundation pages until Filament panels are introduced.
