...
| contracts declare durable API/config/review requirements. Rendered evidence
| files may document examples and display relationships when a future evidence
| surface exists.
|
...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Contract-side API disposition and owner relationship only. Rendered
    | evidence visibility, page copy, sections, and example grouping are
    ...
    */
    ...
    'catalog' => [
        ...
        | Do not duplicate rendered evidence page copy, section order, or
        | example grouping here.
        */
        'detail_pages' => [
            /*
            'usage' => [
