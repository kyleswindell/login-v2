    ...
    <x-slot:sidebar>
        <div class="space-y-6 xl:flex xl:h-full xl:flex-col">
            <div class="rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30">
                ...
                <div class="mt-6">
                    <a href="{{ route('dashboard') }}" class="inline-flex rounded-2xl border border-slate-700 px-4 py-3 text-sm font-semibold text-slate-100 transition hover:border-sky-400 hover:text-sky-300">
                        Back to app
                    </a>
                </div>
            </div>
        ...
        <div id="selected-doc" class="rounded-3xl border border-slate-800 bg-slate-900/70 p-8">
            @if ($selectedFile)
                <article class="max-w-none text-slate-300
                    ...
                    [&_table]:mt-6 [&_table]:w-full [&_table]:border-collapse [&_table]:overflow-hidden [&_table]:rounded-2xl
