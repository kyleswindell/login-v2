...
--}}
<div class="flex w-full flex-col gap-4 lg:flex-row" data-mobile-sidebar-tabs data-default-panel="{{ request()->routeIs('platform.settings.*') ? 'settings' : 'setup' }}">
    <div class="grid grid-cols-2 gap-2 lg:hidden">
        <button
            type="button"
            class="rounded-md border border-slate-700 px-3 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-slate-300 transition hover:border-slate-500 hover:text-white"
            data-mobile-sidebar-target="setup"
        >
            Setup
        </button>
        <button
            type="button"
            class="rounded-md border border-slate-700 px-3 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-slate-300 transition hover:border-slate-500 hover:text-white"
            data-mobile-sidebar-target="settings"
        >
            Settings
        </button>
    </div>
    ...
    <div class="w-full shrink-0 rounded-lg border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30 lg:w-60 xl:sticky xl:top-24 xl:h-[calc(100vh-7rem)] xl:overflow-y-auto" data-mobile-sidebar-panel="setup">
    ...
    <div class="w-full shrink-0 rounded-lg border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30 lg:w-60 xl:sticky xl:top-24 xl:h-[calc(100vh-7rem)] xl:overflow-y-auto" data-mobile-sidebar-panel="settings">
