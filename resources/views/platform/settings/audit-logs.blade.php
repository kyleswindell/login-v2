<x-layouts.app title="Audit Log Settings">
    ...
    <section class="flex flex-1 flex-col gap-6">
        <div>
            <h1 class="ui-page-header-title">Audit Settings</h1>
            <p class="ui-page-header-copy">Configure log retention period and the severity level used for login events.</p>
        </div>
