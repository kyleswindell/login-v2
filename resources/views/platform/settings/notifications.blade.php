<x-layouts.app title="Notification Settings">
    ...
    <section class="flex flex-1 flex-col gap-6">
        ...
        <form method="POST" action="{{ route('platform.settings.notifications.update') }}" class="rounded-lg border border-slate-800 bg-slate-900/70 p-8 shadow-2xl shadow-black/30">
            @csrf
