<x-layouts.app title="Error Logs Setup">
    <section class="flex flex-1 flex-col gap-6">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <a href="{{ route('platform.operations.error-logs.index') }}" class="group rounded-3xl border border-slate-800 bg-slate-900/70 p-6 transition hover:border-sky-500/40 hover:bg-slate-900">
            ...
            <a href="{{ route('platform.settings.general.system-server-info') }}" class="group rounded-3xl border border-slate-800 bg-slate-900/70 p-6 transition hover:border-sky-500/40 hover:bg-slate-900">
