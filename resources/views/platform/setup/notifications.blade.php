<x-layouts.app title="Platform Notifications Setup">
    <section class="flex flex-1 flex-col gap-6">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <a wire:navigate href="{{ route('platform.administration.notifications.index') }}" class="group rounded-lg border border-slate-800 bg-slate-900/70 p-6 transition hover:border-sky-500/40 hover:bg-slate-900">
            ...
            <a wire:navigate href="{{ route('platform.settings.notifications') }}" class="group rounded-lg border border-slate-800 bg-slate-900/70 p-6 transition hover:border-sky-500/40 hover:bg-slate-900">
