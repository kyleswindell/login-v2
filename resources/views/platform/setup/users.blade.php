<x-layouts.app title="Platform Users Setup">
    <section class="flex flex-1 flex-col gap-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <a href="{{ route('platform.users.create') }}" class="group rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30 transition hover:border-sky-500/40 hover:bg-slate-900">
            ...
            <a href="{{ route('platform.users.index') }}" class="group rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30 transition hover:border-sky-500/40 hover:bg-slate-900">
            ...
            <a href="{{ route('platform.settings.users') }}" class="group rounded-3xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30 transition hover:border-sky-500/40 hover:bg-slate-900">
