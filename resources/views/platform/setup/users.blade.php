<x-layouts.app title="Platform Users Setup">
    <section class="flex flex-1 flex-col gap-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            ...
            <a wire:navigate href="{{ route('platform.settings.users') }}" class="group rounded-lg border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-black/30 transition hover:border-slate-600 hover:bg-slate-900">
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-slate-300">Defaults</p>
                ...
                <p class="mt-4 text-xs font-semibold uppercase tracking-[0.2em] text-slate-500 group-hover:text-slate-300">Open settings page</p>
            </a>
        </div>
    </section>
</x-layouts.app>
