...
<div class="space-y-6" data-component-live-layout="pagination-matrix" data-ui-reference-sample-type="pagination">
    <div class="ui-tabs ui-tabs-contained" data-ui-tabs data-ui-tabs-activation="manual" data-pagination-variant-tabs>
        <div class="ui-tabs-list" role="tablist" aria-label="Pagination variants">
            <button id="pagination-default-tab" type="button" class="ui-tabs-tab" role="tab" aria-selected="true" aria-controls="pagination-default-panel" data-ui-tabs-tab>
                Pagination
            </button>
            <button id="pagination-nav-tab" type="button" class="ui-tabs-tab" role="tab" aria-selected="false" aria-controls="pagination-nav-panel" tabindex="-1" data-ui-tabs-tab>
                Pagination nav
            </button>
        </div>

        <div class="ui-tabs-panels">
            <section id="pagination-default-panel" class="ui-tabs-panel space-y-6" role="tabpanel" aria-labelledby="pagination-default-tab" data-ui-tabs-panel>
                <section class="rounded-lg border p-4" style="border-color: var(--ui-border-subtle-01); background-color: var(--ui-layer-01);" data-pagination-live-section="pagination-bar-sizes">
                    ...
                    <p class="mt-2 text-sm leading-6" style="color: var(--ui-text-secondary);">Small, medium, and large bars use working controls. Changing items per page recalculates total pages and the visible item range.</p>

                    <div class="mt-4 grid gap-4">
                        <x-ui.pagination id="pagination-bar-sm" label="Small workspace table pagination" variant="pagination" size="sm" :current-page="1" :total-pages="11" :total-items="103" :page-size="10" :page-size-options="$pageSizeOptions" base-url="#" interactive />
                        <x-ui.pagination id="pagination-bar-md" label="Medium workspace table pagination" variant="pagination" size="md" :current-page="2" :total-pages="11" :total-items="103" :page-size="10" :page-size-options="$pageSizeOptions" base-url="#" interactive />
                        <x-ui.pagination id="pagination-bar-lg" label="Large workspace table pagination" variant="pagination" size="lg" :current-page="11" :total-pages="11" :total-items="103" :page-size="10" :page-size-options="$pageSizeOptions" base-url="#" interactive />
                    </div>
                </section>
                            ...
                            <div class="mt-4">
                                ...
                                >
                                    <x-slot name="paginationSlot">
                                        <x-ui.pagination id="pagination-paired-table-control" label="Medium table pagination" variant="pagination" size="md" :current-page="2" :total-pages="11" :total-items="103" :page-size="10" :page-size-options="$pageSizeOptions" base-url="#" interactive />
                                    </x-slot>
                                </x-ui.data-table>
                            </div>
                        </article>
            ...
            <section id="pagination-nav-panel" class="ui-tabs-panel space-y-6" role="tabpanel" aria-labelledby="pagination-nav-tab" data-ui-tabs-panel hidden>
