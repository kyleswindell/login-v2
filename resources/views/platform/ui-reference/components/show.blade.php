<x-layouts.app :title="'UI Reference - '.$catalogComponent['label']">
    ...
    <section class="flex min-w-0 flex-1 flex-col gap-6" data-ui-reference-component="{{ $slug }}" data-ui-reference-t1-component="{{ $slug }}" data-ui-reference-component-disposition="{{ $catalogComponent['disposition'] }}" data-ui-reference-component-status="{{ $catalogComponent['status'] }}">
        ...
        <section class="ui-reference-component-section" data-component-card="purpose" data-component-section="purpose">
            <div class="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(18rem,0.55fr)]">
                ...
                <aside class="ui-reference-component-panel" data-component-section="implementation-status">
        ...
        <section class="ui-reference-component-section" data-component-card="use-cases">
            ...
            <div class="mt-5 grid min-w-0 gap-4 xl:grid-cols-2">
                <article class="ui-reference-component-panel" data-component-section="use-when">
                ...
                <article class="ui-reference-component-panel" data-component-section="do-not-use-when">
        ...
        <section class="ui-reference-component-section" data-component-card="component-contract">
            ...
            <div class="mt-5 grid min-w-0 gap-4 xl:grid-cols-2">
                <article class="ui-reference-component-panel" data-component-section="anatomy">
                ...
                <article class="ui-reference-component-panel" data-component-section="states">
                    <h3 class="text-sm font-semibold" style="color: var(--ui-text-primary);">States</h3>
                    <div class="mt-3 flex flex-wrap gap-2">
                        @foreach ($catalogComponent['states'] as $state)
                            <span class="inline-flex items-center whitespace-nowrap rounded-full border px-2.5 py-1 text-xs font-semibold" style="border-color: var(--ui-border-subtle-01); color: var(--ui-text-secondary); background-color: var(--ui-layer-02);">{{ $state }}</span>
                        @endforeach
                    </div>
                </article>
            </div>
            ...
            <div class="mt-4 grid min-w-0 gap-4 xl:grid-cols-2">
                <article class="ui-reference-component-panel" data-component-section="behavior">
                ...
                <article class="ui-reference-component-panel" data-component-section="developer-implementation">
                ...
                <article class="ui-reference-component-panel" data-component-section="content-guidance">
                ...
                <article class="ui-reference-component-panel" data-component-section="accessibility">
        ...
        <section class="ui-reference-component-section" data-component-card="live-examples" data-component-section="live-examples">
                    ...
                    >
                        <div class="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(18rem,0.45fr)]">
                            ...
                            @if (! empty($example['context_notes']))
                                <aside class="min-w-0 rounded-lg border p-3" style="border-color: var(--ui-border-subtle-01); background-color: var(--ui-layer-02);">
                        ...
                        <div class="mt-5 min-w-0" data-ui-reference-live-example="{{ $example['id'] }}">
                            ...
                            @else
                                <div class="rounded-lg border p-4" style="border-color: var(--ui-border-subtle-01); background-color: var(--ui-layer-02);">
                        ...
                        <div class="mt-5 min-w-0 rounded-lg border p-4" style="border-color: var(--ui-border-subtle-01); background-color: var(--ui-layer-02);" data-component-section="variants-for-example">
                            ...
                            <div class="mt-3 grid min-w-0 gap-3 md:grid-cols-2">
                                @foreach ($example['variants'] ?? [] as $variant)
                                    <div
                                        ...
                                        style="border-color: var(--ui-border-subtle-01); background-color: var(--ui-layer-03);"
                                    >
        ...
        <section class="ui-reference-component-section" data-component-card="related-components-and-patterns" data-component-section="related-components-and-patterns">
            ...
            <div class="mt-4 flex flex-wrap gap-2">
                @foreach ($catalogComponent['related'] as $related)
                    <a wire:navigate href="{{ $related['href'] }}" class="rounded-full border px-3 py-1.5 text-xs font-semibold transition" style="border-color: var(--ui-border-subtle-01); background-color: var(--ui-layer-01); color: var(--ui-text-secondary);">{{ $related['label'] }}</a>
                @endforeach
            </div>
        </section>
    </section>
