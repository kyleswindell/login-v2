    ...
    <section class="flex flex-1 flex-col gap-6">
        ...
        <section class="ui-card" data-ui-guidance="badge-feedback-semantics" data-guidance-id="P2-F-CQ-009">
            ...
            <div class="mt-3 grid gap-4 lg:grid-cols-2">
                <div>
                    <h2 class="text-base font-semibold ui-reference-text-strong">Badge semantic mapping</h2>
                    <dl class="mt-3 space-y-3 text-sm ui-reference-text">
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-BADGE-01 - Neutral and info</dt>
                            <dd class="mt-1">Use neutral for passive metadata and info for contextual facts that do not require action.</dd>
                        </div>
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-BADGE-02 - Success and notice</dt>
                            <dd class="mt-1">Use success for completed or healthy states and notice for queued, scheduled, or review-oriented states.</dd>
                        </div>
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-BADGE-03 - Warning and danger</dt>
                        ...
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-BADGE-04 - Text-first status</dt>
                ...
                <div>
                    <h2 class="text-base font-semibold ui-reference-text-strong">Login App 2.0 boundary</h2>
                    <p class="mt-3 text-sm ui-reference-text">Badge semantics use the existing Login App 2.0 neutral, info, success, notice, warning, and danger set. Carbon is a coverage benchmark only; do not adopt Carbon visual tokens, color names, or component chrome.</p>
        ...
        <section class="ui-card" data-ui-reference-example="badge-status-contract" data-guidance-id="P2-F-CQ-009">
            <p class="ui-kicker">Component Badge And Status Reference Examples</p>
            ...
            <div class="mt-5 grid gap-5 lg:grid-cols-2">
                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Base semantic badges</p>
                    ...
                    <code class="mt-3 block rounded-md ui-reference-code-surface px-3 py-2 text-xs ui-reference-text">&lt;x-ui.badge label=&quot;queued review&quot; semantic=&quot;notice&quot; /&gt;</code>
                </article>

                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Outline + no-icon states</p>
                    <div class="mt-3 flex flex-wrap gap-2">
                    ...
                    <p class="mt-3 text-sm ui-reference-text-muted">Icons are optional reinforcement. The text label remains the status source of truth.</p>
                </article>

                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Inline status for dense rows</p>
                    ...
                    <code class="mt-3 block rounded-md ui-reference-code-surface px-3 py-2 text-xs ui-reference-text">&lt;x-ui.status status=&quot;degraded&quot; /&gt;</code>
                </article>

                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">List context</p>
                    <div class="mt-3 space-y-3">
                        <div class="flex flex-wrap items-center justify-between gap-3 ui-reference-subtle-surface px-3 py-2">
                            <span class="text-sm font-semibold ui-reference-text-strong">Audit export</span>
                            <x-ui.badge label="scheduled" semantic="notice" />
                        </div>
                        <div class="flex flex-wrap items-center justify-between gap-3 ui-reference-subtle-surface px-3 py-2">
                            <span class="text-sm font-semibold ui-reference-text-strong">Webhook replay</span>
        ...
        <section class="ui-card" data-ui-implementation-guide="feedback-status" data-guidance-id="P2-F-CQ-009">
            ...
            <div class="mt-4 ui-reference-table-shell overflow-x-auto">
                <table class="w-full min-w-[720px] ui-reference-table-body text-left text-sm">
                    <thead class="ui-reference-table-head text-xs uppercase tracking-[0.16em] ui-reference-text-muted">
                        <tr>
                    ...
                    <tbody class="ui-reference-table-body ui-reference-text">
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Compact badge</td>
                        ...
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Dense row status</td>
        ...
        <section class="ui-card">
            ...
            <p class="mt-2 text-sm ui-reference-text-muted">Tier 1 badges are limited to base and outline variants only.</p>
            <div class="mt-4 grid gap-4 lg:grid-cols-2">
                <div class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Base Status</p>
                    <div class="mt-3 flex flex-wrap gap-2">
                ...
                <div class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Outline Status</p>
                    <div class="mt-3 flex flex-wrap gap-2">
            ...
            <p class="mt-4 text-sm ui-reference-text-muted">Disabled is not part of the Tier 1 badge/status contract, so it is intentionally not shown here.</p>
        </section>

        <section class="ui-card">
            <p class="ui-kicker">Inline Status Pattern</p>
            <p class="mt-2 text-sm ui-reference-text-muted">Lighter status treatment for metadata-heavy rows and logs.</p>
        ...
        <section class="ui-card">
            ...
            <div class="mt-4 ui-reference-table-shell overflow-x-auto">
                <table class="w-full min-w-[720px] ui-reference-table-body">
                    ...
                    <tbody class="ui-reference-table-body text-sm ui-reference-text-strong">
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">North Region Tenant</td>
                        ...
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Messaging Queue</td>
                        ...
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Webhook Replay Service</td>
