    ...
    <section class="flex flex-1 flex-col gap-6">
        ...
        <section class="ui-card" data-ui-reference-element-inventory>
            ...
            <div class="mt-5 overflow-x-auto rounded-lg border border-slate-800 bg-slate-950/60">
                <table class="w-full min-w-[980px] table-fixed divide-y divide-slate-800">
                    <colgroup>
                        <col class="w-[10rem]">
                        <col class="w-[13rem]">
                        <col class="w-[19rem]">
                        ...
                        @foreach ($elementCatalog as $element)
                            <tr data-ui-reference-element-row="{{ $element['slug'] }}">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span class="inline-flex items-center whitespace-nowrap rounded-full border border-slate-700 px-2 py-1 text-xs font-semibold text-slate-200">{{ $element['disposition'] }}</span>
                                </td>
