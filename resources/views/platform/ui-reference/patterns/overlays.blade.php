    ...
    <section class="flex flex-1 flex-col gap-6">
        ...
        <section class="ui-card" data-ui-guidance="notification-feedback-usage" data-guidance-id="P2-F-CQ-009">
            ...
            <div class="mt-3 grid gap-4 lg:grid-cols-2">
                <div>
                    <h2 class="text-base font-semibold ui-reference-text-strong">Feedback surface selection</h2>
                    <dl class="mt-3 space-y-3 text-sm ui-reference-text">
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-NOTIF-01 - Inline alert</dt>
                            <dd class="mt-1">Use inline alerts for feedback that belongs inside a form, card, table, or persistent content region.</dd>
                        </div>
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-NOTIF-02 - Toast</dt>
                        ...
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-NOTIF-03 - Callout or banner</dt>
                        ...
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-NOTIF-04 - Severity and live region</dt>
                        ...
                        <div>
                            <dt class="font-semibold ui-reference-text-strong">G-NOTIF-05 - Stacking and placement</dt>
                ...
                <div>
                    <h2 class="text-base font-semibold ui-reference-text-strong">Same-page feedback rules</h2>
                    <ul class="mt-3 list-disc space-y-2 pl-5 text-sm ui-reference-text">
        ...
        <section class="ui-card" data-ui-reference-example="feedback-surface-contract" data-guidance-id="P2-F-CQ-009">
            <p class="ui-kicker">Pattern Feedback Surface Examples</p>
            <div class="mt-5 grid gap-5 xl:grid-cols-2">
                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Form validation feedback</p>
                ...
                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Table/list feedback</p>
                    <div class="mt-3 space-y-3">
                        <x-ui.inline-alert semantic="info" title="Filters applied">
                            Showing active workspace rows owned by Platform Team.
                        </x-ui.inline-alert>
                        <div class="flex flex-wrap items-center justify-between gap-3 rounded-md border ui-reference-border ui-reference-subtle-surface px-3 py-2">
                            <span class="text-sm ui-reference-text-strong">North Region Tenant</span>
                ...
                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Page-level callout/banner</p>
                    <div class="mt-3">
                    ...
                    <p class="mt-3 text-sm ui-reference-text-muted">Use page-level feedback when the message affects the whole surface, not a single field.</p>
                </article>

                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">AJAX same-page toast stack</p>
            ...
            <div class="mt-5 ui-reference-example-surface p-4" data-ui-reference-example="notification-center-handoff">
                <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Persisted notification handoff</p>
                <p class="mt-3 text-sm ui-reference-text">Transient toast confirms the same-page action. Durable messages such as export completion, security review, or background failure also appear in the notification center or page content so they remain available after dismissal.</p>
            </div>
        </section>
            ...
            <div class="mt-4 ui-reference-table-shell overflow-x-auto">
                <table class="w-full min-w-[780px] text-left text-sm">
                    ...
                    <tbody class="ui-reference-table-body">
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Inline/page alert</td>
                        ...
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Transient toast</td>
                        ...
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Persisted notification</td>
        ...
        <section class="ui-card" data-ui-guidance="overlay-loading-usage" data-guidance-id="P2-F-CQ-011">
            ...
            <div class="mt-3 grid gap-4 lg:grid-cols-3">
                <dl class="space-y-3 text-sm ui-reference-text">
                    <div>
                        <dt class="font-semibold ui-reference-text-strong">G-MODAL-01 - Modal variants</dt>
                    ...
                    <div>
                        <dt class="font-semibold ui-reference-text-strong">G-MODAL-02 - Focus trap</dt>
                    ...
                    <div>
                        <dt class="font-semibold ui-reference-text-strong">G-MODAL-03 - Modal vs page or panel</dt>
                ...
                <dl class="space-y-3 text-sm ui-reference-text">
                    <div>
                        <dt class="font-semibold ui-reference-text-strong">G-TOOLTIP-01 - Tooltip vs toggletip</dt>
                    ...
                    <div>
                        <dt class="font-semibold ui-reference-text-strong">G-TOOLTIP-02 - Definition tooltip</dt>
                ...
                <dl class="space-y-3 text-sm ui-reference-text">
                    <div>
                        <dt class="font-semibold ui-reference-text-strong">G-LOAD-01 - Spinner vs skeleton</dt>
                    ...
                    <div>
                        <dt class="font-semibold ui-reference-text-strong">G-LOAD-02 - Full-page vs inline loading</dt>
        ...
        <section class="ui-card" data-ui-reference-example="overlay-loading-contract" data-guidance-id="P2-F-CQ-011">
            ...
            <div class="mt-5 grid gap-5 xl:grid-cols-2">
                ...
                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Tooltip vs toggletip</p>
                    <div class="mt-3 flex flex-wrap items-center gap-4">
                        <div class="group relative inline-flex">
                            ...
                            <span id="tooltip-reference-example" role="tooltip" class="pointer-events-none absolute left-1/2 top-full z-10 mt-2 hidden -translate-x-1/2 whitespace-nowrap rounded-md border ui-reference-border-strong ui-reference-code-surface px-3 py-2 text-xs ui-reference-text-strong shadow-xl group-hover:block">
                                Short non-interactive help
                            </span>
                        </div>
                        <details class="ui-reference-subtle-surface px-3 py-2 text-sm ui-reference-text">
                            <summary class="cursor-pointer font-semibold ui-reference-text-strong">Toggletip</summary>
                ...
                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Inline loading</p>
                    <div class="mt-3 flex items-center gap-3 text-sm ui-reference-text">
                ...
                <article class="ui-reference-example-surface p-4">
                    <p class="text-xs font-semibold uppercase tracking-[0.15em] ui-reference-text-muted">Skeleton loading</p>
                    <div class="mt-3 space-y-2" aria-label="Loading content block">
                        <div class="h-4 w-2/3 rounded ui-reference-skeleton-line"></div>
                        <div class="h-4 w-full rounded ui-reference-skeleton-line"></div>
                        <div class="h-4 w-5/6 rounded ui-reference-skeleton-line"></div>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="ui-card">
            ...
            <p class="mt-2 text-sm ui-reference-text-muted">Use right-side drawer for contextual details while preserving table context. See live behavior in Table Baselines.</p>
            <div class="mt-4 grid gap-4 lg:grid-cols-2">
                <article class="ui-reference-example-surface p-4">
                    <h2 class="text-sm font-semibold uppercase tracking-[0.15em] ui-reference-text">Required Behavior</h2>
                ...
                <article class="ui-reference-example-surface p-4">
                    <h2 class="text-sm font-semibold uppercase tracking-[0.15em] ui-reference-text">Implementation Path</h2>
                    <p class="mt-3 text-sm ui-reference-text">Drawer hooks are implemented by `data-audit-log-*` and `data-error-log-*` selectors in `resources/js/app.js` with matching modal shells in the tables reference page.</p>
                </article>
            </div>
        ...
        <section class="ui-card">
            ...
            <p class="mt-2 text-sm ui-reference-text-muted">Tier 1 inline alerts use the base display only and cover the canonical severity map.</p>
        ...
        <section class="ui-card">
            ...
            <div class="mt-4 overflow-x-auto ui-reference-example-surface">
                <table class="min-w-[820px] w-full divide-y divide-slate-800">
                    ...
                    <tbody class="text-sm ui-reference-text-strong">
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Drawer baseline</td>
                        ...
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Modal baseline</td>
                        ...
                        <tr>
                            <td class="px-4 py-3 ui-reference-text-strong">Inline alerts + toasts</td>
        ...
        >
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="ui-reference-example-surface p-4">
                    <h3 class="text-xs font-semibold uppercase tracking-[0.2em] ui-reference-text-muted">Focus Return Rule</h3>
                    <p class="mt-3 text-sm ui-reference-text">Close this drawer with the footer action or `Escape` and confirm focus returns to the triggering control.</p>
                </div>
            </div>
